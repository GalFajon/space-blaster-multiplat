...
public class Projectile : Physics, IAnimatable
{
    ...
    public Projectile(float damage, float x, float y, Vector2 dir, float speed, Scene scene, SceneObject parent = null) : base(x, y, new Rectangle(0, 0, 6, 6), true, scene, parent)
    {
