...
public class Enemy : Physics, IArtificialIntelligence, IAnimatable
{
    ...
    public Enemy(int health, float x, float y, Rectangle rect, bool canCollide, SpaceBlaster.Scene.Scene scene, SceneObject parent = null) : base(x, y, rect, canCollide, scene, parent)
    {
