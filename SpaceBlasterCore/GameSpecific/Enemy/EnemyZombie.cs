...
public class EnemyZombie : Enemy, IPathFollower, IAnimatable
{
    ...
    public EnemyZombie(float x, float y, SpaceBlaster.Scene.Scene scene, SceneObject parent = null) : base(5, x, y, new Rectangle(0, 0, 32, 32), true, scene, parent)
    {
        ...
        this.AnimationPlayer = new AnimationPlayer(
            new Dictionary<int, AnimatedSprite>(){
                { 0, new AnimatedSprite(SpaceBlaster.SpaceBlasterGame.TextureAtlas, new Vector2(88, 3), 2, 0.2, 16, 13, 3, 0f) },
                { 1,  new AnimatedSprite(SpaceBlaster.SpaceBlasterGame.TextureAtlas, new Vector2(89, 21), 4, 0.2, 16, 13, 3, 0f) }
            }
        );
    ...
    public override void HandleAI(GameTime gameTime, Scene scene)
    {
        base.HandleAI(gameTime, scene);
